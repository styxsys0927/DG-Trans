...
class STransformer(nn.Module):
    ...
    def forward(self, value, key, query):
        ...
        start.record()
        attention, adj = self.attention(value, key, query)
        end.record()
...
class STTransformerBlock(nn.Module):
    ...
    def forward(self, value, key, query, t):
        # Add skip connection,run through normalization and finally dropout
        x1, adj = self.STransformer(value, key, query)
...
class Transformer(nn.Module):
    ...
    def forward(self, src, t):
        enc_src, adj = self.encoder(src, t)
        return enc_src, adj
...
class STTransformer(nn.Module):
    ...
    def forward(self, x, t):
        ...
        output_Transformer, adj = self.Transformer(input_Transformer, t-3)
